...
<link href="./css/kh_layout.css" rel="stylesheet" type="text/css">
<link href="./css/kh_modal.css" rel="stylesheet" type="text/css">
<!-- header -->
<link href="./css/kh_header.css" rel="stylesheet" type="text/css">
<!-- article -->
<link href="./css/kh_article1.css" rel="stylesheet" type="text/css">
<!-- aside -->
<link href="./css/kh_aside.css" rel="stylesheet" type="text/css">

<!-- Script 파일 추가 -->
<script src="./js/kh_modal.js"></script>
</head>
<body>
    <div id="main_wrap">
